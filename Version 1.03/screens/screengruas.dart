...
class Screengruas extends StatelessWidget {
  final List<Contacto> contactos = [
    Contacto('Grúas Gonzalez', '5802-9816 Claro', 'Juigalpa', 5.0,
    ...
    Contacto('Servicios de Grúas "CORTEZ"', '8615-9480 Claro y 8991-3035 Tigo',
        'Juigalpa y Managua', 4.5, "https://acortar.link/co0hei"),
    ...
    Contacto('Gruas Managua  Servicio de Grua para todo Nicaragua', '75178157',
        'Juigalpa-Managua', 5.0, "https://wa.link/vqrleh"),
  ];

  Screengruas({super.key});
