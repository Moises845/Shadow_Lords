        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              const CircleAvatar(
                radius: 65,
                // Coloca aquí la imagen del perfil del usuario si la tienes
                // backgroundImage: AssetImage('ruta_de_la_imagen'),
              ),
              const SizedBox(height: 10.0),  // Añade un espacio entre el CircleAvatar y el texto
            const Text(
            ...
            Container(
              ...
              child: const UserDataItem(label: "Nombre de Usuario", value: "Jose Emilio Barrera"),
            ),
            Container(
              padding: const EdgeInsets.all(10.0),
              child: const UserDataItem(label: "Teléfono", value: "+505 87314566"),
            ),
            Container(
              padding: const EdgeInsets.all(10.0),
              child: const UserDataItem(label: "Correo Electrónico", value: "josebarrera555@gmail.com"),
            ),
            Container(
              padding: const EdgeInsets.all(10.0),
              child: const UserDataItem(label: "Ubicación", value: "Juigalpa, Chontales"),
            ),
            const SizedBox(height: 20.0),
            ElevatedButton(
              onPressed: () {
